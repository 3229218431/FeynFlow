...
```json
{
  ...
  "data": {
    "values": [
      {"app": "电磁铁/继电器", "importance": 5},
      {"app": "磁悬浮", "importance": 4},
      {"app": "磁透镜/电子束", "importance": 4},
      {"app": "感应加热", "importance": 3},
      {"app": "磁屏蔽", "importance": 3},
      {"app": "电机/发电机", "importance": 5},
      {"app": "霍尔传感器", "importance": 3}
    ]
  },
  "encoding": {
    "x": {"field": "app", "type": "nominal", "title": "应用", "sort": "-y"},
    "y": {"field": "importance", "type": "quantitative", "title": "重要性/频率"},
    "color": {"field": "app", "type": "nominal", "legend": null}
  }
}
```
...
## 更多费曼检验
1. 电磁铁和永磁体各有什么优势和劣势？设计一个场景说明何时选电磁铁、何时选永磁体。
2. 磁悬浮列车利用涡流的排斥力——这对应楞次定律的什么效应？
